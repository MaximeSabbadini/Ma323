...
class Application(tk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.combo = ttk.Combobox(self.master, values=['Explicite centré', 'Implicite centré', 'Lax-Friedrichs', 'Lax-Wendroff'], justify=tk.CENTER)
        ...
        self.l1.place(x=10, y=660)
        self.e1.place(x=40, y=658)
        self.l2.place(x=330, y=660)
        self.e2.place(x=365, y=658)
        self.c1.place(x=1300, y=660)
